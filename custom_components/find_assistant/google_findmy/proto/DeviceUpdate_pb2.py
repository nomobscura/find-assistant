...
from . import Common_pb2 as ProtoDecoders_dot_Common__pb2
...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'custom_components.find_assistant.google_findmy.proto.DeviceUpdate_pb2', _globals)
