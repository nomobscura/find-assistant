// Find Assistant -- Lovelace view strategy.
//
...
//
// Registered as a custom element per HA's Lovelace strategy contract
// (https://developers.home-assistant.io/docs/frontend/custom-ui/custom-strategy/):
// tag name "ll-strategy-view-<type>", static generate(config, hass).
//
// Usage, in a dashboard's raw YAML editor:
//   views:
//     - strategy:
...
class FindAssistantTrackersStrategy extends HTMLElement {
...
customElements.define("ll-strategy-view-find-assistant-trackers", FindAssistantTrackersStrategy);
